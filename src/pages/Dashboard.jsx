  ...
  <div className="space-y-6">
    <div className="flex justify-between items-end border-b border-slate-200 pb-4">
      ...
      <div className="text-sm font-bold text-slate-400 uppercase tracking-wider">
        {AVAILABLE_VAULTS.length} Vaults Active
      </div>
    </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <div className="bg-slate-50 p-3 rounded-lg flex-1 border border-slate-100">
                ...
                <p className="font-bold text-slate-700">{vault.duration}</p>
              </div>
            </div>
          </div>

          <button className="w-full py-3.5 bg-white border-2 border-slate-200 text-slate-700 font-bold rounded-xl uppercase tracking-wider hover:bg-ashesi-red hover:text-white hover:border-ashesi-red transition-all shadow-sm">
            Request Funds
          </button>
        </div>
      ))}
